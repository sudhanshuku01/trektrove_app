...
import kafuli_IMG from '../images/Others/defalutukimg.jpg';
...
const foodItems: FoodItem[] = [
  ...
  },
  {
    name: 'Baadi',
    description:
      'Baadi is a famous Uttarakhand food that has mesmerized the locals and tourists for a long time, mainly by its lingering aroma and tangy taste. This dish is as simple as the people of Uttarakhand. It is bequeathed with all the essential nutrients that are hard to find in one dish altogether. It is abundant in Vitamin B12 and Vitamin A among others. What more can we ask for when we get nutrients and taste in a single delicacy!',
    image: kafuli_IMG,
    url: 'google.com',
  },
  {
